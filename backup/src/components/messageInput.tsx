...
ort.env.wasm.wasmPaths = `${basePath}/_next/static/chunks/`;
      ...
      try {
        switch (config("stt_backend")) {
          case 'whisper_browser': {
            ...
            const audioArray = new Float32Array(audio.buffer.slice(0) as ArrayBuffer);
            buffer.copyToChannel(audioArray, 0, 0);
          ...
          case 'whisper_openai': {
            ...
            const file = new File([new Uint8Array(wavBuffer.buffer.slice(0) as ArrayBuffer)], "input.wav", { type: "audio/wav" });
