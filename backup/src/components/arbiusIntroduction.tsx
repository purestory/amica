    ...
    >
      <div className="mx-auto max-h-full overflow-auto rounded-lg bg-white/80 p-4 backdrop-blur-lg shadow-lg">
        <div className="my-4">
          ...
          <p>{t("amica_intro", `
            Amica is the best way for AI to interact with humans. This interface shows how people may interact with AI. With this setup, anyone may interact with Amica and receive responses. This is set up as a global demonstration, so do not expect any privacy.
          `)}
          </p>
        </div>
