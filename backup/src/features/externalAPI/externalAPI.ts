...
export const getConfigUrl = () => `${getApiBaseUrl()}/amica-api/dataHandler/?type=config`;
export const getSubconsciousUrl = () => `${getApiBaseUrl()}/amica-api/dataHandler/?type=subconscious`;
export const getLogsUrl = () => `${getApiBaseUrl()}/amica-api/dataHandler/?type=logs`;
export const getUserInputMessagesUrl = () => `${getApiBaseUrl()}/amica-api/dataHandler/?type=userInputMessages`;
export const getChatLogsUrl = () => `${getApiBaseUrl()}/amica-api/dataHandler/?type=chatLogs`;
